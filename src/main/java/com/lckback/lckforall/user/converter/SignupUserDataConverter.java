...
public class SignupUserDataConverter {
    ...
    public static User convertToUser(SignupUserDataDto.SignupUserData signupUserData, String profileImageUrl) {
        UserRole role = UserRole.valueOf(signupUserData.getRole().toUpperCase());
        UserStatus status = UserStatus.valueOf(signupUserData.getStatus().toUpperCase());
